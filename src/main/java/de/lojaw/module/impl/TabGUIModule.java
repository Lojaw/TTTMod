...
public class TabGUIModule implements Module {

    private String name = "TabGUI";
    ...
    public void onEnable() {
        ...
        if (player != null) {
            player.sendMessage(Text.of("[TTTMod] Das TabGUI Modul wurde aktiviert"));
        }
    }
    ...
    public void onDisable() {
        ClientPlayerEntity player = MinecraftClient.getInstance().player;
        if (player != null) {
            player.sendMessage(Text.of("[TTTMod] Das TabGUI Modul wurde deaktiviert"));
        }
    }
